                    ...
                    child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Color.fromARGB(255, 68, 76, 242), // Background color
                            foregroundColor:
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        ...
                        color: Color.fromARGB(255, 76, 106, 255)),
                  ),
                ],
              ),
            ),
    ...
    Row(
      ...
      children: [
        Container(
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: Color.fromARGB(255, 78, 110, 237).withOpacity(0.8),
          ),
          child: IconButton(
            icon: Icon(Icons.remove, size: 20, color: Colors.white),
            onPressed: () {
              if (item.jumlah > 0) {
                onQuantityChanged(item.jumlah - 1); // Mengurangi jumlah item
              }
            },
          ),
        ),
        SizedBox(width: 10),
        Text(
          item.jumlah.toString().padLeft(2, '0'),
        ...
        Container(
          ...
          child: IconButton(
            ...
            onPressed: () {
              onQuantityChanged(item.jumlah + 1); // Menambah jumlah item
                    },
                  ),
                ),
              ],
