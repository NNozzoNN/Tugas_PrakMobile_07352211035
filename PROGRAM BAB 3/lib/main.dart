  ...
  final List<Map<String, dynamic>> freelancers = [
    {
      ...
      "rating": 4.9,
      "image": "assets/images/G2_ut.png"
    },
    {
      "name": "MR.Beast",
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/G3_mr-beast.png"
    },
    {
      "name": "Bill Gates",
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/G4_bill-gates.png"
    },
    {
      "name": "Zendaya",
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/G5_zendaya.png"
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10),
        ServiceCard(
          imageUrl: 'assets/images/G7_nail-art.png',
        ...
        ServiceCard(
          imageUrl: 'assets/images/G10_business-woman.png',
          name: 'Miss Zachary Will',
          role: 'Beautician',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
        ...
        ServiceCard(
          imageUrl: 'assets/images/G9_nail-art2.png',
          name: 'Miss Zachary Will',
          role: 'Beautician',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
  ...
  Widget build(BuildContext context) {
    return Column(
        children: [
          BestBookingCard(
            imageUrl: 'assets/images/G9_nail-art2.png',
            profileUrl: 'assets/images/G5_zendaya.png',
            name: 'Miss Zachary Will',
            role: 'Beautician',
          ...
          BestBookingCard(
            imageUrl: 'assets/images/G6_store.png',
            profileUrl: 'assets/images/G5_zendaya.png',
            name: 'Miss Zachary Will',
            role: 'Beautician',
            description: 'Occaecati aut nam beatae quo non deserunt consequatur.',
